...
codeRes = np.loadtxt(open("./breakthrough.dat", "rb"), usecols = (1,2), delimiter=" ", skiprows=0)


tau = [0.5, 2.0, 3.0, 4.0, 30,  100]
pl = 1e-2*np.power(tau,-3/2)
plsp = 1e-2*np.power(tau,-1/2)
...
plt.loglog  (tau,plsp,'r-',label='power law 1/2')
